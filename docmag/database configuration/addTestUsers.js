...
function addTeachers(database) {
  ...
  for (arr in algebraTeachers) {
     var teacherProfile = {
      firstName: algebraTeachers[arr][0], 
      surname: algebraTeachers[arr][1],
      lastName: algebraTeachers[arr][2], 
      email: algebraTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Алгебра",
      degree: algebraTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[1]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var mechanicsTeachers = [
  ...
  for (arr in mechanicsTeachers) {
     var teacherProfile = {
      firstName: mechanicsTeachers[arr][0], 
      surname: mechanicsTeachers[arr][1],
      lastName: mechanicsTeachers[arr][2], 
      email: mechanicsTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Аналитична механика",
      degree: mechanicsTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[2]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  for (arr in voisTeachers) {
     var teacherProfile = {
      firstName: voisTeachers[arr][0], 
      surname: voisTeachers[arr][1],
      lastName: voisTeachers[arr][2], 
      email: voisTeachers[arr][4], 
      faculty: "ФМИ",
      department: "ВОИС",
      degree: voisTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[3]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var geometryTeachers = [
  ...
  for (arr in geometryTeachers) {
     var teacherProfile = {
      firstName: geometryTeachers[arr][0], 
      surname: geometryTeachers[arr][1],
      lastName: geometryTeachers[arr][2], 
      email: geometryTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Геометрия",
      degree: geometryTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[4]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  for (arr in deTeachers) {
     var teacherProfile = {
      firstName: deTeachers[arr][0], 
      surname: deTeachers[arr][1],
      lastName: deTeachers[arr][2], 
      email: deTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Диференциални уравнения",
      degree: deTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[5]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  for (arr in csTeachers) {
     var teacherProfile = {
      firstName: csTeachers[arr][0], 
      surname: csTeachers[arr][1],
      lastName: csTeachers[arr][2], 
      email: csTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Изчислителни системи",
      degree: csTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[6]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  for (arr in isTeachers) {
     var teacherProfile = {
      firstName: isTeachers[arr][0], 
      surname: isTeachers[arr][1],
      lastName: isTeachers[arr][2], 
      email: isTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Информационни технологии",
      degree: isTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[7]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var complexAnalisysTeachers = [
  ...
  for (arr in complexAnalisysTeachers) {
     var teacherProfile = {
      firstName: complexAnalisysTeachers[arr][0], 
      surname: complexAnalisysTeachers[arr][1],
      lastName: complexAnalisysTeachers[arr][2], 
      email: complexAnalisysTeachers[arr][4], 
      faculty: "ФМИ",
      department: " Комплексен анализ и топология",
      degree: complexAnalisysTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[8]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  var logicTeachers = [
    ...
    ["Христо", "Александров", "Ганчев", "h.ganchev@fmi.uni-sofia.bg"],
  ...
  for (arr in logicTeachers) {
     var teacherProfile = {
      firstName: logicTeachers[arr][0], 
      surname: logicTeachers[arr][1],
      lastName: logicTeachers[arr][2], 
      email: logicTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Математическа логика и приложенията й",
      degree: logicTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[9]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
  ...
  for (arr in eduTeachers) {
     var teacherProfile = {
      firstName: eduTeachers[arr][0], 
      surname: eduTeachers[arr][1],
      lastName: eduTeachers[arr][2], 
      email: eduTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Обучение по математика и информатика",
      degree: eduTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[10]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var softTechnTeachers = [
  ...
  for (arr in softTechnTeachers) {
     var teacherProfile = {
      firstName: softTechnTeachers[arr][0], 
      surname: softTechnTeachers[arr][1],
      lastName: softTechnTeachers[arr][2], 
      email: softTechnTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Софтуерни технологии",
      degree: softTechnTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[11]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var numMethodsTeachers = [
  ...
  for (arr in numMethodsTeachers) {
     var teacherProfile = {
      firstName: numMethodsTeachers[arr][0], 
      surname: numMethodsTeachers[arr][1],
      lastName: numMethodsTeachers[arr][2], 
      email: numMethodsTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Числени методи и алгоритми",
      degree: numMethodsTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[12]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});

  }

  var analisysTeachers = [
  ...
  for (arr in analisysTeachers) {
     var teacherProfile = {
      firstName: analisysTeachers[arr][0], 
      surname: analisysTeachers[arr][1],
      lastName: analisysTeachers[arr][2], 
      email: analisysTeachers[arr][4], 
      faculty: "ФМИ",
      department: "Математически анализ",
      degree: analisysTeachers[arr][3]
    }
    userCollection.insert({username: "t" + "[13]" + arr, password: "teacher", type : "Teacher", profile: teacherProfile});
